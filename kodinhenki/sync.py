...
# Last modified: Sat Jul 14 08:19:10 2018 mstenber
# Edit time:     224 min
#
"""
...
This code uses SHSP (HNCP sub-protocol) to synchronize the state across.
...
class Syncer(pysyma.shsp.SHSPSubscriber):
    ...
    def dict_update_event(self, n, od, nd):
        if n is self.p.own_node:
            return
        if nd.get('hostname', [None, ''])[1] == self.hostname:
            return
